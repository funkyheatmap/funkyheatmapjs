 ...
 *   `funkyrect` for numerical data, and `text` for categorical data. See {@link module:geoms}
 *   for available options
 * @property {string} palette - name of the palette to use for coloring the column. Must be defined
 *   in {@link module:palettes~PaletteMapping} or be a default palette
 *   (see {@link module:palettes~defaultPalettes})
